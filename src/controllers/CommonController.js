...
exports.dashboard = async (req, res) => {
    try {  
        const blogsCount = await Blogs.countDocuments({ deletedAt: null });
        const enquiriesCount = await Enquiry.countDocuments({ deletedAt: null });
        return res.success({ blogsCount, enquiriesCount });
    } catch (error) {
